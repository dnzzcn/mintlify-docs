...
<Card title="Agent Skills" icon="brain" href="/capabilities/agent-skills">
  Package specialized data analysis workflows and domain expertise into reusable skills
</Card>
