...
<Card title="Next: Code Execution" icon="code" href="/capabilities/code-execution">
  Discover how Maia generates and executes code for calculations and visualizations
</Card>
